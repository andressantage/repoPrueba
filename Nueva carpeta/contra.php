...
<body style="text-align: center;">
    <div class="login-box">
        ...
        <h2>Escribe al WhatsApp</h2>
        <form method="post" action="validar.php">
            <a style="width=100px" href="https://api.whatsapp.com/send?phone=3163748711" target="_blank" rel="noopener noreferrer">
                <i class="fab fa-whatsapp fa-10x"></i>
            </a>
        </form>
        <h3>Descubre encima del icono</h3>
    </div>
</body>
</html>